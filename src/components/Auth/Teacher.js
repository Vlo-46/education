...
const Teacher = ({subjects}) => {
    ...
    const ValidationSchema = teacherValidator

    return (
        <>
            <Formik
                initialValues={{name: '', surname: '', email: '', password: '', phone: '', confirm: '', profession: ''}}
                ...
                {({
                    ...
                    <form onSubmit={handleSubmit} className={`${styles.form} mb-3 p-5`}>
                        ...
                        <div className="form-group" style={{position: 'relative'}}>
                            ...
                            >
                                <option value="" disabled>Ընտրել մասնագիտությունը</option>
                                {
                                    subjects.map(sub => (
                            ...
                            <img src="assets/icons/earth.svg" alt="user" className={styles.inputLeftIcon}/>
